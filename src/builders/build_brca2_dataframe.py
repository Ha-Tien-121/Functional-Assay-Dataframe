...
OUTPUT_FILE = OUTPUT_DIR / "master_dataframes" / "BRCA2_master_dataframe.csv"
MAPPING_FILE = REF_DIR / "Functional Assay Mapping - Sheet1.csv"

# File paths
CRAVAT_FILE = DATA_DIR / "BRCA2/BRCA2_annotated.csv.gz"
PILLAR_FILE = DATA_DIR / "BRCA2/BRCA2_pillar_data.csv"
RICHARDSON_FILE = DATA_DIR / "BRCA2/Supplemental_Table_1_Richardson_BRCA2_2021_PMID33609447.xlsx - Sheet1.csv"
HU_FILE = DATA_DIR / "BRCA2/BRCA2_pillar_data.csv" # Mapped from pillar
HUANG_FILE = DATA_DIR / "BRCA2/SuppTables_Huang_BRCA2_2025_PMID39779857.xlsx - Table S3.csv"
IKEGAMI_FILE = DATA_DIR / "BRCA2/SuppData5_Ikegami_BRCA2_2020_PMID32444794.xlsx - Results of Bayesian inference.csv"
HART_FILE = DATA_DIR / "BRCA1/Table S2.xls - Table S2.csv" # Shared file with BRCA1
BISWAS_FILE = DATA_DIR / "BRCA2/table1_Biswas_2020_BRCA2_PMID33293522.csv"
MESMAN_FILE = DATA_DIR / "BRCA2/Table 1 and Table 2 extracted - Table 1.csv"
GUIDUGLI_FILE = DATA_DIR / "BRCA2/table1_BRCA2_Guidugli_2018_PMID29394989.csv"
SAHU_2023_FILE = DATA_DIR / "BRCA2/BRCA2_pillar_data.csv" # Mapped from pillar
...
def main():
    ...
    UNMAPPED_FILE = OUTPUT_DIR / "diagnostics" / "BRCA2_variants_not_mapped.csv"
    ...
    NOT_MERGED_FILE = OUTPUT_DIR / "diagnostics" / "BRCA2_variants_not_merged.csv"
