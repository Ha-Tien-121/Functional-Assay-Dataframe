...
OUTPUT_FILE = OUTPUT_DIR / "master_dataframes" / "VHL_master_dataframe.csv"
...
def main():
    ...
    UNMAPPED_FILE = OUTPUT_DIR / "diagnostics" / "VHL_variants_not_mapped.csv"
    ...
    NOT_MERGED_FILE = OUTPUT_DIR / "diagnostics" / "VHL_variants_not_merged.csv"
